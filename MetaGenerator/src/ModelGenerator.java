...
public class ModelGenerator {
	...
	public static void generate(Table table) throws JClassAlreadyExistsException{
		JCodeModel codeModel = new JCodeModel();
	  	...
	  	JPackage jp = codeModel._package(Temporary.modelPkg);
	  	...
	  	for(Column co : c){
			  JFieldVar var = null;
			  if(co.isForeignKey()){
				var = jc.field(JMod.PRIVATE, codeModel.ref(Temporary.modelPkg+"."+Helper.sentenceCase(co.getTableReference())), camelcasify(co.getName()));
			  }else{
